...
def wrapper(instance, filename, target, param):
...
class Card(models.Model):
    front_image = models.ImageField(upload_to=partial(wrapper, target="front", param="front_text"), null=True,
                                    blank=True)
    front_text = models.TextField(verbose_name="Front Text Card", help_text="Text of the front card")
    back_image = models.ImageField(upload_to=partial(wrapper, target="back", param="back_text"), null=True, blank=True)
